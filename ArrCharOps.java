...
public class ArrCharOps {
    ...
    public static char charAt(char[] arr, int index) {
        ...
        // Checks if the index is within the bounds of the array, and is positive
    ...
    public static int lastIndexOf(char[] arr, char ch) {
        ...
        // the loop is checking from the back of the array to the front
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        // Replace the following statement with your code
        char[] concacted = new char[arr1.length + arr2.length];
        for (int i = 0; i < arr1.length; i++) { concacted[i] = arr1[i]; }
        for (int i = 0; i < arr2.length; i++) {   concacted[i + arr1.length] = arr2[i]; }
        return concacted;
    }
